...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.country.delete.question">
        <Translate contentKey="gadiApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-country" color="danger" onClick={confirmDelete}>
