...
export const PersonDeleteDialog = (props: IPersonDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.person.delete.question">
        <Translate contentKey="gadiApp.person.delete.question" interpolate={{ id: personEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-person" color="danger" onClick={confirmDelete}>
