...
export const EducationDeleteDialog = (props: IEducationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.education.delete.question">
        <Translate contentKey="gadiApp.education.delete.question" interpolate={{ id: educationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-education" color="danger" onClick={confirmDelete}>
