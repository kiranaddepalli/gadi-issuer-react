...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.address.delete.question">
        <Translate contentKey="gadiApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-address" color="danger" onClick={confirmDelete}>
