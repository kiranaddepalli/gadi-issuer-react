...
export const OrganizationDeleteDialog = (props: IOrganizationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.organization.delete.question">
        <Translate contentKey="gadiApp.organization.delete.question" interpolate={{ id: organizationEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-organization" color="danger" onClick={confirmDelete}>
