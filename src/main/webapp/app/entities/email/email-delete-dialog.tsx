...
export const EmailDeleteDialog = (props: IEmailDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.email.delete.question">
        <Translate contentKey="gadiApp.email.delete.question" interpolate={{ id: emailEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-email" color="danger" onClick={confirmDelete}>
