...
export const DriverLicenseDeleteDialog = (props: IDriverLicenseDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gadiApp.driverLicense.delete.question">
        <Translate contentKey="gadiApp.driverLicense.delete.question" interpolate={{ id: driverLicenseEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="dt-confirm-delete-driverLicense" color="danger" onClick={confirmDelete}>
